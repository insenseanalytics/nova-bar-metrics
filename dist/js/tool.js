...
Nova.booting(function (Vue, router) {
    router.addRoutes([{
        name: 'nova-bar-metrics',
        path: '/nova-bar-metrics',
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Nova Bar Metrics")]),
      _vm._v(" "),
      _c(
        "card",
        {
        ...
        [
          ...
          _c("p", { staticClass: "text-white-50% text-lg" }, [
            ...
            _c(
              ...
              [
                _vm._v(
                  "/nova-tools/NovaBarMetrics/resources/js/components/Tool.vue"
                )
              ]
            )
          ])
